...
--   
        if((CCIO_EN_M = "TRUE") or
           (CCIO_EN_M = "FALSE")) then
             FIRST_TIME := false;
        else
           assert false
           report "Attribute Syntax Error: The Legal values for CCIO_EN_M are TRUE or FALSE"
           severity Failure;
        end if;

--   
        if((CCIO_EN_S = "TRUE") or
           (CCIO_EN_S = "FALSE")) then
             FIRST_TIME := false;
        else
           assert false
           report "Attribute Syntax Error: The Legal values for CCIO_EN_S are TRUE or FALSE"
           severity Failure;
        end if;
