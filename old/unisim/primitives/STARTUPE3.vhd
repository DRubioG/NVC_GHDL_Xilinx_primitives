...
begin
  ...
  unisim.vcomponents.FCSBO_GLBL <= FCSBO when (FCSBTS = '0') else
  'H';
  unisim.vcomponents.DO_GLBL(0) <= DO(0) when (DTS(0) = '0') else
  'H';
  unisim.vcomponents.DO_GLBL(1) <= DO(1) when (DTS(1) = '0') else
  'H';
  unisim.vcomponents.DO_GLBL(2) <= DO(2) when (DTS(2) = '0') else
  'H';
  unisim.vcomponents.DO_GLBL(3) <= DO(3) when (DTS(3) = '0') else
  'H';
