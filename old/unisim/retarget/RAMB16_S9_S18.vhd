...
-- /___/   /\     Filename : RAMB16_S9_S18.vhd
-- \   \  /  \    Timestamp : Thu Oct 28 3:05:27 PST 2010
--  \___\/\___\
--
-- Revision:
...
architecture RAMB16_S9_S18_V of RAMB16_S9_S18 is
signal DOA_BUS : std_logic_vector(15 downto 0);
signal DOPA_BUS : std_logic_vector(1 downto 0);
signal DIA_BUS : std_logic_vector(15 downto 0);
signal DIPA_BUS : std_logic_vector(1 downto 0);
...
begin
     WEA_BUS <= "0" & WEA;
     WEB_BUS <= "00" & WEB & WEB;
     DIA_BUS <= "00000000" & DIA;
     DIPA_BUS <= "0" & DIPA;
     ADDRA_BUS <= ADDRA(10 downto 0) & "0" & "0" & "0";
     ADDRB_BUS <= ADDRB(9 downto 0) & "0" & "0" & "0" & "0";
     R1 : RAMB18E1
     generic map (
        INIT_A => INIT_A,
	INIT_B => INIT_B,
