...
architecture bram_V of BRAM_TDP_MACRO is
  ...
  begin
    if(device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "SPARTAN6" or device_s = "7SERIES") then
      case wr_widtha is
        ...
        when 19 to 36 => if (func_bram_size /= "36Kb" and (device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "7SERIES") ) then
                         write( Message, STRING'("Illegal value of Attribute WRITE_WIDTH_A : ") );
                         write ( Message, WRITE_WIDTH_A);
 ...
 function GetADDRWidth (
  ...
  begin
    if(device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "7SERIES") then
      if (bram_size_s = "18Kb" or bram_size_s = "9Kb") then
        func_width := 16;
      elsif bram_size_s = "36Kb" then
        func_width := 32;
      else
...
begin
 ...
 web1 : if (DEVICE = "VIRTEX5") generate  
   web1_1 : web_pattern <= (WEB & WEB) when (BRAM_SIZE = "18Kb" and web_width = 1 ) else
 ...
 web2 : if (DEVICE = "SPARTAN6") generate  
   web2_1 : web_pattern <= (WEB & WEB) when (BRAM_SIZE = "9Kb" and web_width = 1 ) else
 ...
 web1_3 : web_pattern_bl <= ("00" & WEB & WEB) when (BRAM_SIZE = "18Kb" and web_width = 1  ) else
