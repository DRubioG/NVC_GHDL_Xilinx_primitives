...
signal DOB_BUS : std_logic_vector(31 downto 0);
signal DOPB_BUS : std_logic_vector(3 downto 0);
signal DIB_BUS : std_logic_vector(31 downto 0);
signal DIPB_BUS : std_logic_vector(3 downto 0);
...
begin
     WEA_BUS <= WEA ;
     WEB_BUS <= "0000000" & WEB;
     DIB_BUS <= "000000000000000000000000" & DIB;
     DIPB_BUS <= "000" & DIPB;
     ADDRA_BUS <= "00" & ADDRA(8 downto 0) & "0" & "0" & "0" & "0" & "0";
     ADDRB_BUS <= "00" & ADDRB(10 downto 0) & "0" & "0" & "0" ;
     R1 : RAMB36E1
     generic map (
	INIT_A => INIT_A(0 to 35),
	INIT_B => INIT_B(0 to 8),
	SRVAL_A => SRVAL_A(0 to 35),
	SRVAL_B => SRVAL_B(0 to 8),
