...
-- \   \  /  \    Timestamp : Fri Oct 29 05:48:48 PST 2010
--  \___\/\___\
--
-- Revision:
--    10/29/10 - Initial version.
--    08/30/11 - Fixed RST_PRIORITY (CR 622388).
...
begin
  ...
  begin
   ...
   R18E1 : if((DATA_WIDTH_A <= 18) and (DATA_WIDTH_B <= 18)) generate
     R2 : RAMB18E1
     generic map (
	DOA_REG => DOA_REG,
	DOB_REG => DOB_REG,
        INIT_A => INIT_A(18 to 35),
	INIT_B => INIT_B(18 to 35),
        INIT_FILE => INIT_FILE,
	SRVAL_A => SRVAL_A(18 to 35),
	SRVAL_B => SRVAL_B(18 to 35),
	WRITE_MODE_A => WRITE_MODE_A,
	WRITE_MODE_B => WRITE_MODE_B,
	READ_WIDTH_A => DATA_WIDTH_A,
	READ_WIDTH_B => DATA_WIDTH_B,
