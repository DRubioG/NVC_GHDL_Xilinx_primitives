...
-- /___/   /\     Filename : RAM16X8S.vhd
-- \   \  /  \    Timestamp : Wed Oct 20 05:14:25 PDT 2010
--  \___\/\___\
--
-- Revision:
...
architecture RAM16X8S_V of RAM16X8S is
begin
    R3_1 : RAM32X1S
    generic map (
    ...
    R3_5 : RAM32X1S
    generic map (
      INIT => X"0000" & INIT_04(15 downto 0),
      IS_WCLK_INVERTED => IS_WCLK_INVERTED
    )
    port map (
      O  => O(4),
    ...
    R3_6 : RAM32X1S
    generic map (
      INIT => X"0000" & INIT_05(15 downto 0),
      IS_WCLK_INVERTED => IS_WCLK_INVERTED
    )
    port map (
      O  => O(5),
    ...
    R3_7 : RAM32X1S
    generic map (
      INIT => X"0000" & INIT_06(15 downto 0),
      IS_WCLK_INVERTED => IS_WCLK_INVERTED
    )
    port map (
      O  => O(6),
    ...
    R3_8: RAM32X1S
    generic map (
      INIT => X"0000" & INIT_07(15 downto 0),
      IS_WCLK_INVERTED => IS_WCLK_INVERTED
    )
    port map (
      O  => O(7),
