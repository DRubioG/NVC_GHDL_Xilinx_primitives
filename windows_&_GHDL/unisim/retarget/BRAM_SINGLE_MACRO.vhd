...
architecture bram_V of BRAM_SINGLE_MACRO is
  ...
  begin
    if (device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "SPARTAN6" or device_s = "7SERIES") then
      case wr_width is
        when 0 => func_width := 1;
        ...
        when 37 to 72 => if (func_bram_size /= "36Kb" and (device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "7SERIES") ) then
                         ...
                         DEALLOCATE (Message);
                         -- begin s1
                         elsif (func_bram_size /= "18Kb" and (device_s = "SPARTAN6") ) then
                         write( Message, STRING'("Illegal value of Attribute WRITE_WIDTH : ") );
                         write ( Message, WRITE_WIDTH);
        ...
        when others => if(device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "7SERIES") then
                       write( Message, STRING'("Illegal value of Attribute WRITE_WIDTH : ") );
                       write ( Message, WRITE_WIDTH);
  ...
  begin
    ...
    if (device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "SPARTAN6" or device_s = "7SERIES") then
      ...
      if(device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "7SERIES") then
  ...
  begin
    if (device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "7SERIES") then
      if bram_size_s = "18Kb" and d_width <= 18 then
        func_width := 16;
      elsif bram_size_s = "18Kb" and d_width > 18 and d_width <= 36 then
        func_width := 32;
      elsif bram_size_s = "36Kb" and d_width <= 36 then
        func_width := 32;
      elsif bram_size_s = "36Kb" and d_width > 36 and d_width <= 72 then
        func_width := 64;
      else
        func_width := 64;
      end if;
    -- begin s5 
      ...
      if bram_size_s = "9Kb" and d_width <= 18 then
        func_width := 16;
      elsif bram_size_s = "9Kb" and d_width > 18 and d_width <= 36 then
        func_width := 32;
      elsif bram_size_s = "18Kb" and d_width <= 36 then
        func_width := 32;
      elsif bram_size_s = "18Kb" and d_width <= 72 then
        func_width := 64;
      else
        func_width := 32;
      end if; -- end s5
  ...
  begin
    ...
    -- begin s7
      ...
      if bram_size_s = "9Kb" and d_width <= 18 then
        ...
        func_width := 4;
      elsif bram_size_s = "18Kb" and d_width > 36 and d_width <= 72 then
        func_width := 8;
      else
        func_width := 4;
      end if; -- end s7
  ...
  begin
    ...
    if ( device_s = "VIRTEX5" or device_s = "VIRTEX6" or device_s = "7SERIES") then 
       if (bram_size_s = "18Kb" or bram_size_s = "36Kb") then
        bram_val := TRUE;
       else
        bram_val := FALSE;
        write( Message, STRING'("Illegal value of Attribute BRAM_SIZE : ") );
        write ( Message, bram_size_s);
        write( Message, STRING'(". Legal values of this attribute are ") );
   ...
   -- begin s9
      if (device_s = "SPARTAN6") then
       if(bram_size_s = "9Kb" or bram_size_s = "18Kb") then
        bram_val := TRUE;
       else
        bram_val := FALSE;
        write( Message, STRING'("Illegal value of Attribute BRAM_SIZE : ") );
