...
-- /___/   /\     Filename : RAMB16_S18_S36.vhd
-- \   \  /  \    Timestamp : Thu Oct 28 3:10:56 PST 2010
--  \___\/\___\
--
-- Revision:
...
architecture RAMB16_S18_S36_V of RAMB16_S18_S36 is
signal DOA_BUS : std_logic_vector(31 downto 0);
signal DOPA_BUS : std_logic_vector(3 downto 0);
signal DIA_BUS : std_logic_vector(31 downto 0);
signal DIPA_BUS : std_logic_vector(3 downto 0);
...
begin
     WEA_BUS <= "00" & WEA & WEA;
     WEB_BUS <= "0000" & WEB & WEB &  WEB & WEB;
     DIA_BUS <= "0000000000000000" & DIA;
     DIPA_BUS <= "00" & DIPA;
     ADDRA_BUS <= "00" & ADDRA & "0" & "0" & "0" & "0";
	...
	RSTREGARSTREG => SSRA,
        ...
        DOA <= DOA_BUS(15 downto 0);
        DOPA <= DOPA_BUS(1 downto 0);
end RAMB16_S18_S36_V;
