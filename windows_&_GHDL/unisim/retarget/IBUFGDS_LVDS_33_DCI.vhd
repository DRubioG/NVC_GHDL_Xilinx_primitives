...
-- /___/   /\     Filename : IBUFGDS_LVDS_33_DCI.vhd
...
architecture IBUFGDS_LVDS_33_DCI_V of IBUFGDS_LVDS_33_DCI is
begin
    I2 : IBUFGDS
    generic map (
      IOSTANDARD => "LVDS_33_DCI"
    )
    port map (
      O  => O,
      IB => IB,
