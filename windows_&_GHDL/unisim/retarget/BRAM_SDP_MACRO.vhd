...
architecture bram_V of BRAM_SDP_MACRO is
  ...
  begin
    ...
    if (DEVICE = "VIRTEX5" or DEVICE = "VIRTEX6" or DEVICE = "SPARTAN6" or DEVICE = "7SERIES") then
      if rd_width = 0 then
                         ...
                         DEALLOCATE (Message);
     -- begin s2
      elsif (DEVICE = "SPARTAN6" and bram_size_s = "9Kb" and rd_width > 36 and DEVICE = "SPARTAN6") then
                         write( Message, STRING'("Illegal value of Attribute READ_WIDTH : ") );
                         write ( Message, READ_WIDTH);
     ...
     elsif bram_size_s = "18Kb" and rd_width > 36 then
                         write( Message, STRING'("Illegal value of Attribute READ_WIDTH : ") );
                         write ( Message, READ_WIDTH);
                         ...
                         ASSERT FALSE REPORT Message.ALL SEVERITY Failure;
                         DEALLOCATE (Message);
      elsif bram_size_s = "36Kb" and rd_width > 72 then
                         write( Message, STRING'("Illegal value of Attribute READ_WIDTH : ") );
                         write ( Message, READ_WIDTH);
     ...
     if wr_width = 0 then
                         ...
                         DEALLOCATE (Message);
    -- begin s3
     elsif (DEVICE = "SPARTAN6" and bram_size_s = "9Kb" and wr_width > 36) then
                         write( Message, STRING'("Illegal value of Attribute WRITE_WIDTH : ") );
                         write ( Message, WRITE_WIDTH);
                         write( Message, STRING'(". Legal values of this attribute for BRAM_SIZE 9Kb are ") );
                         write( Message, STRING'(" 1 to 36 .") );
     ...
     elsif bram_size_s = "18Kb" and wr_width > 36 then
                         write( Message, STRING'("Illegal value of Attribute WRITE_WIDTH : ") );
                         write ( Message, WRITE_WIDTH);
                         write( Message, STRING'(". Legal values of this attribute for BRAM_SIZE 18Kb are ") );
                         write( Message, STRING'(" 1 to 36 .") );
                         ASSERT FALSE REPORT Message.ALL SEVERITY Failure;
                         DEALLOCATE (Message);
     elsif bram_size_s = "36Kb" and wr_width > 72 then
                         write( Message, STRING'("Illegal value of Attribute WRITE_WIDTH : ") );
                         write ( Message, WRITE_WIDTH);
                         write( Message, STRING'(". Legal values of this attribute are ") );
                         write( Message, STRING'(" 1 to 36 for BRAM_SIZE of 9Kb, 18Kb and") );
     ...
     if (DEVICE = "SPARTAN6" and bram_size_s = "9Kb" and (wr_width > 18 or rd_width > 18) and ( write_width /= read_width) ) then
                         write( Message, STRING'("Illegal value of Attribute READ_WIDTH : ") );
                         write ( Message, READ_WIDTH);
                         write( Message, STRING'(" . Illegal value of Attribute WRITE_WIDTH : ") );
                         write ( Message, WRITE_WIDTH);
  ...
  begin
    if (DEVICE = "VIRTEX5" or DEVICE = "VIRTEX6" or DEVICE = "SPARTAN6" or DEVICE = "7SERIES") then
       case w_width is
        ...
        when 19 to 36 => if(bram_size_s = "36Kb") then
                         func_width := 32;
                         else
  ...
  begin
    ...
    -- begin b4
      ...
      if bram_size_s = "18Kb" and d_width <= 36 then
        func_width := 4;
      elsif bram_size_s = "36Kb" and d_width <= 72 then
        func_width := 8;
      else
        func_width := 4;
      end if; -- end b4
