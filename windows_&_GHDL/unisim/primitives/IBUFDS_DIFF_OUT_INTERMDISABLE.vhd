...
----- CELL IBUFDS_DIFF_OUT_INTERMDISABLE -----
...
architecture IBUFDS_DIFF_OUT_INTERMDISABLE_V of IBUFDS_DIFF_OUT_INTERMDISABLE is
  ...
  constant MODULE_NAME : string := "IBUFDS_DIFF_OUT_INTERMDISABLE";
  ...
  begin
    -------- DIFF_TERM check
      if((xil_attr_test) or
        ...
        Write ( Message, string'(IBUFDS_DIFF_OUT_INTERMDISABLE_V'PATH_NAME));
...
begin
   ...
   begin
     IBUFDISABLE_BIN := (IBUFDISABLE_in and USE_IBUFDISABLE_BIN);
