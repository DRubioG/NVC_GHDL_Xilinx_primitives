...
begin
  ...
  CB_dly         	 <= '1' when (CB = 'U') else CB xor IS_CB_INVERTED_BIN          	after 0 ps; --rv 1
  CE_C_dly       	 <= CE             	after 0 ps;
  CE_CB_dly      	 <= CE             	after 0 ps;
  D_C_dly        	 <= D xor IS_D_INVERTED_BIN            	after 0 ps;
  D_CB_dly       	 <= D xor IS_D_INVERTED_BIN            	after 0 ps;
