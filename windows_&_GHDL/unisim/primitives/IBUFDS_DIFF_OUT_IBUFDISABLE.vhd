...
----- CELL IBUFDS_DIFF_OUT_IBUFDISABLE -----
...
architecture IBUFDS_DIFF_OUT_IBUFDISABLE_V of IBUFDS_DIFF_OUT_IBUFDISABLE is
  ...
  constant MODULE_NAME : string := "IBUFDS_DIFF_OUT_IBUFDISABLE";
  constant OUTCLK_DELAY : time := 100 ps;
  
-- Parameter encodings and registers
  constant CCIO_EN_M_FALSE : std_ulogic := '1';
  constant CCIO_EN_M_TRUE : std_ulogic := '0';
  constant CCIO_EN_S_FALSE : std_ulogic := '1';
  constant CCIO_EN_S_TRUE : std_ulogic := '0';
  ...
  constant SIM_DEVICE_VERSAL_PREMIUM : std_logic_vector(4 downto 0) := "01101";
  constant SIM_DEVICE_VERSAL_PREMIUM_ES1 : std_logic_vector(4 downto 0) := "01110";
  constant SIM_DEVICE_VERSAL_PREMIUM_ES2 : std_logic_vector(4 downto 0) := "01111";
  constant SIM_DEVICE_VERSAL_PRIME : std_logic_vector(4 downto 0) := "10000";
  constant SIM_DEVICE_VERSAL_PRIME_ES1 : std_logic_vector(4 downto 0) := "10001";
  ...
  signal CCIO_EN_M_BIN : std_ulogic;
  signal CCIO_EN_S_BIN : std_ulogic;
 ...
 signal out_b_val : std_ulogic := '1';
  ...
  CCIO_EN_M_BIN <= 
      CCIO_EN_M_TRUE when (CCIO_EN_M = "TRUE") else
      CCIO_EN_M_FALSE when (CCIO_EN_M = "FALSE") else
      CCIO_EN_M_TRUE;
  
  CCIO_EN_S_BIN <= 
      CCIO_EN_S_TRUE when (CCIO_EN_S = "TRUE") else
      CCIO_EN_S_FALSE when (CCIO_EN_S = "FALSE") else
      CCIO_EN_S_TRUE;
  ...
  begin
    -------- CCIO_EN_M check
      if((xil_attr_test) or
         ((CCIO_EN_M /= "TRUE") and 
          (CCIO_EN_M /= "FALSE"))) then
        attr_err := true;
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-101] CCIO_EN_M attribute is set to """));
        Write ( Message, string'(CCIO_EN_M));
        Write ( Message, string'(""". Legal values for this attribute are "));
        Write ( Message, string'("""TRUE"" or "));
        Write ( Message, string'("""FALSE"". "));
        Write ( Message, string'("Instance "));
        Write ( Message, string'(IBUFDS_DIFF_OUT_IBUFDISABLE_V'PATH_NAME));
    ...
    -------- CCIO_EN_S check
      if((xil_attr_test) or
         ((CCIO_EN_S /= "TRUE") and 
          (CCIO_EN_S /= "FALSE"))) then
        attr_err := true;
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-102] CCIO_EN_S attribute is set to """));
        Write ( Message, string'(CCIO_EN_S));
        Write ( Message, string'(""". Legal values for this attribute are "));
        Write ( Message, string'("""TRUE"" or "));
        Write ( Message, string'("""FALSE"". "));
        Write ( Message, string'("Instance "));
    ...
    -------- DIFF_TERM check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-104] DIFF_TERM attribute is set to """));
    ...
    -------- DQS_BIAS check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-105] DQS_BIAS attribute is set to """));
    ...
    -------- IBUF_LOW_PWR check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-106] IBUF_LOW_PWR attribute is set to """));
    ...
    -------- IOSTANDARD check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-108] IOSTANDARD attribute is set to """));
    ...
    -------- USE_IBUFDISABLE check
     ...
     ((USE_IBUFDISABLE /= "FALSE") and 
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-110] USE_IBUFDISABLE attribute is set to """));
...
--out_val <= '0' when (SIM_DEVICE_BIN = SIM_DEVICE_ULTRASCALE or SIM_DEVICE_BIN = SIM_DEVICE_VERSAL or SIM_DEVICE_BIN = SIM_DEVICE_VERSAL_ES1 or SIM_DEVICE = SIM_DEVICE_VERSAL_ES2) else
  --            '1' when (SIM_DEVICE = SIM_DEVICE_7SERIES);
--out_b_val <= 'X' when (SIM_DEVICE = "ULTRASCALE") else
  --            '1' when (SIM_DEVICE = "7SERIES") else
--	      '0' when (SIM_DEVICE = "VERSAL" or SIM_DEVICE = "VERSAL_ES1" or SIM_DEVICE = "VERSAL_ES2");
...
begin
   ...
   prcs_output : process (IBUFDISABLE_in, I_in, IB_in, USE_IBUFDISABLE_BIN, DQS_BIAS_BIN)
