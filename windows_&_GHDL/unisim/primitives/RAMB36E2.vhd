...
-- INIT_FILE
  ...
  memp_we_b <= WEBWE_in when (WRITE_WIDTH_B_BIN > WRITE_WIDTH_B_4) else X"00";
    ...
    synd_wr <= fn_ecc(c_encode, DINBDIN_in & DINADIN_in, DINPBDINP_in & DINPADINP_in);
