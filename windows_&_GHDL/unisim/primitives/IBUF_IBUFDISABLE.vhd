...
architecture IBUF_IBUFDISABLE_V of IBUF_IBUFDISABLE is
  ...
  constant MODULE_NAME : string := "IBUF_IBUFDISABLE";
  ...
  begin
    -------- IBUF_LOW_PWR check
      if((xil_attr_test) or
        ...
        Write ( Message, string'(IBUF_IBUFDISABLE_V'PATH_NAME));
...
begin
  ...
  O_out <=   TO_X01(I_in) when ((USE_IBUFDISABLE = "FALSE") OR (USE_IBUFDISABLE = "T_CONTROL") OR ((USE_IBUFDISABLE = "TRUE") AND (IBUFDISABLE_in = '0'))) else
