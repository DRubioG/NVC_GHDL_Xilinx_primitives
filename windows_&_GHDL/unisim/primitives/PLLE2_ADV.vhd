  ...
  begin
    if (rst_in = '1') then
       ...
       if (clkin_hold_f = 1) then
         ...
         assert FALSE  report " Warning : input CLKIN1 of PLLE2_ADV is stopped. Reset is required for PLLE2_ADV when input clock returns." severity warning;
         else
         assert FALSE report " Warning : input CLKIN2 of PLLE2_ADV  is stopped. Reset is required for PLLE2_ADV when input clock returns." severity warning;
         end if;
       end if;
    end if;
